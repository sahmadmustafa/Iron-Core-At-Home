...
#import "EZBarStep3ViewController.h"
#import "UIImage+animatedGIF.h"



@interface EZBarStep3ViewController ()
{
...
@implementation EZBarStep3ViewController


-(void)LoadGifss
{
    NSURL *url = [[NSBundle mainBundle] URLForResource:@"3" withExtension:@"gif"];
...
- (void)timerTick:(NSTimer *)timer
{
    ...
    if(count==0)
    {
        ...
        self.title=[NSString stringWithFormat:@"Step 3 Completed"];
